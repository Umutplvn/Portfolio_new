              ...
              >
                <Box>
                  ...
                  <Typography sx={{ mb: "0.5rem" }}>
                    A dynamic web app for personal trainers and clients,
                    offering customizable profiles, live chat, metric tracking,
                    blogs, and secure Stripe payments.
                  </Typography>
                  <Typography sx={{ color: "#646464" }}>
                    <strong>Powered By:</strong> Redux, JS, React, Stripe, MUI,
                    Socketio, Node.js, MongoDB, Express and more.
                  </Typography>
                </Box>
                <Box
                  sx={{
            ...
            >
              ...
              >
                <Box>
                  ...
                  <Typography sx={{ mb: "0.5rem" }}>
                    A financial management app to track income, expenses, and
                    budgets, offering valuable insights for better financial
                    control.
                  </Typography>
                  <Typography sx={{ color: "#646464" }}>
            ...
            >
              ...
              >
                <Box>
                  ...
                  <Typography sx={{ mb: "0.5rem" }}>
                    Connectify is a social platform where users share photos and
                    notes in a story format to build meaningful connections and
                    share experiences.
                  </Typography>
                  <Typography sx={{ color: "#646464" }}>
                    <strong>Powered By:</strong> Redux, JS, React, Socketio,
                    MongoDb, Express, Node.js, MUI and more.
                  </Typography>
                </Box>
                <Box
                  sx={{
          ...
          <Box sx={{ width: "100%", display: "flex", flexWrap: "wrap" }}>
            ...
            >
              ...
              >
                ...
                >
                  <Link
                    to="https://portfolio-umut.netlify.app/"
                    target="_blank"
                  >
                    <Box
                      sx={{
